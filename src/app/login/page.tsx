    ...
    return (
        <div className="min-h-screen bg-nm-bg text-nm-fg font-sans relative overflow-hidden selection:bg-nm-accent selection:text-white">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none">
                <div className="absolute top-[10%] left-[5%] w-64 h-64 rounded-full shadow-nm-inset opacity-40 animate-nm-float" />
                <div className="absolute bottom-[15%] right-[5%] w-80 h-80 rounded-full shadow-nm-extruded opacity-30 animate-nm-float" />
            </div>
                ...
                <div className="hidden lg:flex lg:w-5/12 bg-nm-bg p-16 flex-col justify-between relative overflow-hidden">
                    <div className="flex items-center gap-4 relative z-10">
                        <div className="w-14 h-14 bg-nm-bg rounded-2xl flex items-center justify-center shadow-nm-extruded">
                            <Shield size={28} className="text-nm-accent fill-current" />
                        </div>
                    ...
                    <div className="relative z-10">
                        <h1 className="font-display text-7xl font-extrabold leading-tight text-nm-fg tracking-tighter mb-8">
                            Welcome <br /> <span className="text-nm-accent">Back</span>.
                        </h1>
                        <p className="text-nm-muted font-medium max-w-sm leading-relaxed text-xl">
                            Access your technical profile and continue your verification journey with the protocol.
                        </p>
                    </div>

                    <div className="space-y-6 relative z-10">
                        <div className="flex items-center gap-6 p-8 rounded-[32px] bg-nm-bg shadow-nm-extruded">
                            <div className="w-14 h-14 rounded-2xl shadow-nm-inset-deep flex items-center justify-center text-nm-accent">
                                <Zap size={28} />
                            </div>
                            <div>
                                <span className="text-xs font-bold text-nm-accent uppercase tracking-widest block mb-1">Encryption</span>
                                <span className="font-bold text-xl text-nm-fg">Modern Handshake</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 flex items-center justify-center p-8 md:p-12 lg:p-24 relative">
                    <div className="w-full max-w-lg bg-nm-bg p-10 md:p-16 rounded-[48px] shadow-nm-extruded relative">
                        {emailSent ? (
                            ...
                            >
                                <div className="mb-12">
                                    <h1 className="font-display text-5xl font-extrabold tracking-tighter mb-4 text-nm-fg">Sign In</h1>
                                    <p className="text-nm-muted text-lg font-medium">
                                        Verify your identity to enter the protocol.
                                    </p>
                                </div>
                                ...
                                <div className="mt-12 text-center">
                                    ...
                                    <Link href="/signup" className="text-nm-accent font-extrabold text-2xl no-underline hover:text-nm-fg transition-colors block active:scale-95">
